...
const base = render(span(fs.readFileSync(basePath, 'utf8')), 'base a5f5432');
const target = render(span(fs.readFileSync(targetPath, 'utf8')), 'target 6ac5ea7');
...
<div class="grid">
  <div class="col"><h2 class="title">Base a5f5432 (before)</h2><div class="md">${base}</div></div>
  <div class="col"><h2 class="title">Target 6ac5ea7 (after)</h2><div class="md">${target}</div></div>
</div>
</body></html>`;
